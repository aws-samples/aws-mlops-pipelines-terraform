...
def get_pipeline(
    ...
    input_data = ParameterString(
        name="InputDataUrl",
        default_value=f"s3://sagemaker-us-east-1-544507241185/sagemaker/DEMO-xgboost-churn/data/RawData.csv",  # Change this to point to the s3 location of your raw input data.
    )
    ...
    cond_lte = ConditionGreaterThanOrEqualTo(
        left=JsonGet(
            ...
            json_path="binary_classification_metrics.accuracy.value"),right=0.8
    )
